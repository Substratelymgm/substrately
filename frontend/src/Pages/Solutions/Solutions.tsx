...
const Solutions = () => {
  return (
    <div className='flex h-full flex-col overflow-x-hidden gap-[4.5rem]'>
      ...
      <section style={{ backgroundImage: `url(${Globe})` }} className='w-full p-4 bg-center bg-cover relative'>
        ...
        <div className="w-full min-h-[calc(100vh-93px)] flex items-center justify-center bg-cover max-w-[1300px] mx-auto bg-center " >
          <div className="relative flex flex-col items-center justify-center z-10 p-[2rem] text-center text-white">
            <h1 className="text-4xl md:text-[64px]  font-bold font-[700]  mb-[2rem]">Our Solutions</h1>
            <span className="block text-base sm:text-3xl mb-[2rem]">
      ...
      <section className='flex flex-col p-4 text-center sm:text-start max-w-[1300px] mx-auto lg:flex-row mt-[5rem] items-center justify-center gap-[3rem]'>
        <div className='flex flex-col gap-[1rem]'>
          <h1 className='font-[700] text-center sm:text-start text-[2rem] sm:text-[3rem] text-[#191919]'>Geospatial risking mapping</h1>
          <span className='font-[400] text-base sm:text-3xl text-[#4B5162] font-[400]'>
      ...
      <section className='w-full p-4'>
        <div className='flex max-w-[1300px] mx-auto  flex-col lg:flex-row max-w-[1300px] mx-auto mt-[5rem] items-center justify-center gap-[3rem]'>
          <div>
            <h1 className='font-[700] text-center sm:text-start text-[2rem] sm:text-[3rem] text-[#191919]'>Scenario Analysis</h1>
            <span className='font-[400]  text-base sm:text-3xl text-[#4B5162] font-[400]'>
      ...
      <section className='w-full p-4'>
        <div className='flex text-center sm:text-start max-w-[1300px] mx-auto p-[1rem] flex-col lg:flex-row mt-[5rem] items-center justify-center gap-[3rem]'>
          <div className='text-[#4B5162]'>
            <h1 className='font-[700] text-center sm:text-start text-[2rem] sm:text-[3rem] text-[#191919] '>Stress Testing and Resilience Assessment</h1>
            <span className='font-[400] text-center sm:text-start text-base sm:text-3xl  font-[400]'>
      ...
      <section className='flex p-4 flex-col text-center sm:text-start max-w-[1300px] mx-auto lg:flex-row mt-[5rem] items-center justify-center gap-[3rem]'>
        <div>
          <h1 className='font-[700] text-center sm:text-start text-[2rem] sm:text-[3rem] text-[#191919]'>Machine Learning Exposure Assessment</h1>
          <span className='font-[400] text-center sm:text-start  text-base sm:text-3xl text-[#4B5162] font-[400]'>
      ...
      <section className='text-center max-w-[1300px] mx-auto text-[1.6rem] sm:text-[4rem] p-4 max-w-[1300px] mx-auto font-[400]'>
      ...
      <section className=' w-full flex flex-col items-center sm:items-start text-center sm:text-start max-w-[1300px] p-4 mx-auto mt-[7rem] gap-[1rem] text-left'>
        <h1 className='text-[2rem] sm:text-[3rem]  font-[600] '>Why people use substrately for
        <p>
      ...
      <section className='w-full  p-4  '>
        <div className="w-full min-h-[calc(100vh-93px)] rounded-xl flex items-center bg-[#002624] justify-center bg-cover max-w-[1300px] mx-auto bg-center " >
          <div className="relative z-10 p-[2rem] text-center text-white">
            ...
            <span className="block mb-[2rem] text-base sm:text-[2rem] text-[#C3C3C3]">
